...
// List of flags and their descriptions can be found in sim/dex-moves.ts
	...
	buzzout: {
		...
		basePower: 0,
		category: "Status",
		shortDesc: "Raises users highest non-Speed stat by 3 stages. Cannot be used twice in battle.",
		name: "Buzz Out",
		pp: 10,
		priority: 0,
	...
	meltdown: {
		...
		basePower: 100,
		category: "Special",
		shortDesc: "Raises Speed by 2 stages, lowers Defense by 1 stage.",
		name: "Meltdown",
		pp: 5,
		priority: 0,
		flags: {protect: 1, mirror: 1, metronome: 1},
	...
	faeoverload: {
		...
		basePower: 120,
		category: "Physical",
		shortDesc: "Lowers the user's Defense and Special Defense by 1 stage.",
		name: "Fae Overload",
		pp: 5,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, metronome: 1},
	...
	metamorphisis: {
		...
		basePower: 0,
		category: "Status",
		shortDesc: "Charges, then raises Attack, Special Attack, and Speed by 1 stage on turn 2. Once per battle.",
		name: "Metamorphisis",
		pp: 5,
		priority: 0,
		flags: {charge: 1, nonsky: 1, metronome: 1, nosleeptalk: 1, failinstruct: 1},
	...
	flicker: {
		...
		basePower: 0,
		category: "Status",
		shortDesc: "Raises the user's Special Attack by 2 stages.",
		name: "Flicker",
		pp: 20,
		priority: 0,
		flags: {snatch: 1, metronome: 1},
	...
	cry: {
		...
		basePower: 50,
		category: "Special",
		shortDesc: "Lowers foe's Attack and Special Attack by 2 stages; confuses user.",
		name: "Cry",
		pp: 10,
		priority: 0,
		flags: {protect: 1, reflectable: 1, mirror: 1, sound: 1, bypasssub: 1, metronome: 1},
	...
	transcendinghit: {
		...
		basePower: 50,
		category: "Physical",
		shortDesc: "50% chance to raise Speed by 1 stage.",
	...
	gradientgrasp: {
		...
		basePower: 95,
		category: "Physical",
		shortDesc: "20% chance to lower targets Defense by 1 stage.",
		name: "Gradient Grasp",
		pp: 15,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, metronome: 1},
